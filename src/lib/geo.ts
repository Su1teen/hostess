...
const localIndex: GeoResult[] = [
  ...
  { id: "p1", label: "Байтерек", sublabel: "Достопримечательность", lng: 71.4306, lat: 51.1283, kind: "place" },
  { id: "p2", label: "Хан Шатыр", sublabel: "ТРЦ · Left Bank", lng: 71.4034, lat: 51.1325, kind: "place" },
  { id: "p3", label: "EXPO Нур Алем", sublabel: "Музей будущего", lng: 71.4165, lat: 51.0894, kind: "place" },
  { id: "p4", label: "Ботанический сад", sublabel: "Парк · Есиль", lng: 71.4162, lat: 51.1063, kind: "place" },
  { id: "p5", label: "Триатлон-парк", sublabel: "Парк · Набережная", lng: 71.4573, lat: 51.1417, kind: "place" },
];
